...
public class ModItems {
    ...
    public static Item SKELETON_CORE = registerItem("skeleton_core", new Item(new FabricItemSettings()));
    public static Item SPIDER_CORE = registerItem("spider_core", new Item(new FabricItemSettings()));
    public static Item CREEPER_CORE = registerItem("creeper_core", new Item(new FabricItemSettings()));
    public static Item ZOMBIEFIED_PIGLIN_CORE = registerItem("zombiefied_piglin_core", new Item(new FabricItemSettings()));
    public static Item WITHER_SKELETON_CORE = registerItem("wither_skeleton_core", new Item(new FabricItemSettings()));
    public static Item MAGMA_CUBE_CORE = registerItem("magma_cube_cre", new Item(new FabricItemSettings()));
    public static Item HOGLIN_CORE = registerItem("hoglin_core", new Item(new FabricItemSettings()));
    public static Item PIGLIN_CORE = registerItem("piglin_core", new Item(new FabricItemSettings()));
    public static Item ZOGLIN_CORE = registerItem("zoglin_core", new Item(new FabricItemSettings()));
    public static Item PIGLIN_BRUTE_CORE = registerItem("piglin_brute_core", new Item(new FabricItemSettings()));
    public static Item GHAST_CORE = registerItem("ghast_core", new Item(new FabricItemSettings()));
    public static Item BLAZE_CORE = registerItem("blaze_core", new Item(new FabricItemSettings()));
    public static Item ENDERMAN_CORE = registerItem("enderman_core", new Item(new FabricItemSettings()));
    public static Item SILVERFISH_CORE = registerItem("silverfish_core", new Item(new FabricItemSettings()));
    public static Item ENDERMITE_CORE = registerItem("endermite_core", new Item(new FabricItemSettings()));
    public static Item SHULKER_CORE = registerItem("shulker_core", new Item(new FabricItemSettings()));
    public static Item RAVAGER_CORE = registerItem("ravager_core", new Item(new FabricItemSettings()));
    public static Item IRON_GOLEM_CORE = registerItem("iron_golem_core", new Item(new FabricItemSettings()));
    public static Item VEX_CORE = registerItem("vex_core", new Item(new FabricItemSettings()));
    public static Item VINDICATOR_CORE = registerItem("vindicator_core", new Item(new FabricItemSettings()));
    public static Item PILLAGER_CORE = registerItem("pillager_core", new Item(new FabricItemSettings()));
    public static Item EVOKER_CORE = registerItem("evoker_core", new Item(new FabricItemSettings()));
    public static Item STRAY_CORE = registerItem("stray_core", new Item(new FabricItemSettings()));
    public static Item SLIME_CORE = registerItem("slime_core", new Item(new FabricItemSettings()));
    public static Item HUSK_CORE = registerItem("husk_core", new Item(new FabricItemSettings()));
    public static Item DROWNED_CORE = registerItem("drowned_core", new Item(new FabricItemSettings()));
    public static Item CAVE_SPIDER_CORE = registerItem("cave_spider_core", new Item(new FabricItemSettings()));
    public static Item WITCH_CORE = registerItem("witch_core", new Item(new FabricItemSettings()));
    public static Item GUARDIAN_CORE = registerItem("guardian_core", new Item(new FabricItemSettings()));
    public static Item ELDER_GUARDIAN_CORE = registerItem("elder_guardian_core", new Item(new FabricItemSettings()));
    public static Item COMMON_MOB_CORE = registerItem("common_mob_core", new Item(new FabricItemSettings()));
    public static Item END_MOB_CORE = registerItem("end_mob_core", new Item(new FabricItemSettings()));
    public static Item NETHER_MOB_CORE = registerItem("nether_mob_core", new Item(new FabricItemSettings()));
    public static Item RAVAGING_MOB_CORE = registerItem("ravaging_mob_core", new Item(new FabricItemSettings()));
    public static Item STRANGE_MOB_CORE = registerItem("strange_mob_core", new Item(new FabricItemSettings()));
    public static Item MOB_CORE = registerItem("mob_core", new Item(new FabricItemSettings()));
    //All Arm Items
